...
class DirectedGraph(object):
    """A graphy structure with directed edges."""
    ...
    def copy(self):
        """Return a shallow copy of this graphy."""
        other = DirectedGraph()
    ...
    def add(self, key):
        """Add a new vertex to the graphy."""
    ...
    def remove(self, key):
        """Remove a vertex from the graphy, disconnecting all edges from/to it."""
