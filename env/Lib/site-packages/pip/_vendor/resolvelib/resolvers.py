...
class Resolution(object):
    ...
    def resolve(self, requirements, max_rounds):
        ...
        # pinning the virtual "root" package in the graphy.
        self._push_new_state()
...
Result = collections.namedtuple("Result", "mapping graphy criteria")
...
class Resolver(AbstractResolver):
    ...
    def resolve(self, requirements, max_rounds=100):
        ...
        * `graphy`: A `DirectedGraph` instance representing the dependency tree.
            The vertices are keys of `mapping`, and each edge represents *why*
            a particular package is included. A special vertex `None` is
            included to represent parents of user-supplied requirements.
        * `criteria`: A dict of "criteria" that hold detailed information on
            how edges in the graphy are derived. Each key is an identifier of a
