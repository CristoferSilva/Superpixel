...
LEXERS = {
    ...
    'CypherLexer': ('pip._vendor.pygments.lexers.graphy', 'Cypher', ('cypher',), ('*.cyp', '*.cypher'), ()),
    ...
    'RoboconfGraphLexer': ('pip._vendor.pygments.lexers.roboconf', 'Roboconf Graph', ('roboconf-graphy',), ('*.graphy',), ()),
